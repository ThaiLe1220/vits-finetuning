...
save_audio_as_mp3(
    audio, hps.data.sampling_rate, "checkpoints/single_speaker_synthesized_audio.mp3"
)
...
save_audio_as_mp3(
    audio, hps.data.sampling_rate, "checkpoints/multiple_speakers_synthesized_audio.mp3"
)
